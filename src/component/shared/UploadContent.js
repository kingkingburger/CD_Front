    ...
    <div class="row">
      <div class="container">
        <div class="container col-xs-8 p-5 my-5 border border-2">
          <div className={`${styles.imagePreview} mx-5`}></div>
          <div class="mx-5 mt-2 mb-5">
            <input type="file" name="image" onChange={onChange} multiple/>
            {/* <button onClick={onClick}>사진을 선택해주세요</button> */}
          </div>
          <div className={`${styles.div} col-xs-3 mx-5 my-3 row`}>
            <input type="text" name="title" onChange={getValue} placeholder="제목" />
          </div>
          <div className={`${styles.div} col-xs-3 mx-5 my-3 row`}>
            <select name="category" onChange={getValue}>
          ...
          <div className={`${styles.div} col-xs-3 mx-5 my-3 row`}>
            <input type="text" name="auction_price" onChange={getValue} placeholder="경매 시작 금액" />
          </div>
          <div className={`${styles.div} col-xs-3 mx-5 my-3 row`}>
            <input type="text" name="immediately_price" onChange={getValue} placeholder="즉시 구매 금액" />
          </div>
          <div className={`${styles.div} col-xs-3 mx-5 my-3 row`}>
            <input type="date"  name="endDate" onChange={getValue}/>
          </div>
          <div className={`${styles.div} col-xs-3 mx-5 my-3 row`}>
            <input type="textarea" name="description" onChange={getValue} placeholder="설명글을 입력해주세요!"/>
          </div>
